...
from ..docs.recommendation_docs import (
    user_metrics_get_docs, user_metrics_post_docs,
    break_recommendation_get_docs, break_recommendation_post_docs,
    break_recommendation_detail_get_docs, break_recommendation_detail_patch_docs,
...
class BreakRecommendationView(APIView):
    ...
    def post(self, request):
        ...
        if force_new:
            # If force is true, we'll bypass the recent recommendation check in the service
            # First, get user metrics
            try:
